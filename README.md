...
local Window = OrionLib:MakeWindow({Name = "Celestial Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Celestial Hub"})
...
W:AddLabel("[+] Celestial Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Celestial Hub(Noitification)",
